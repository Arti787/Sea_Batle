...
class Playing_field(object):
    ...
    def two_deck_ship(self, y):
        ...
        if y <= 8:
            pygame.draw.rect(display.screen, self.hologram_color,
                             [[self.block_place[0] + self.indent + self.block_side_size, self.block_place[1]],
                              self.block_size])
    ...
    def inv_two_deck_ship(self, x):
        ...
        if x <= 8:
            pygame.draw.rect(display.screen, self.hologram_color,
                             [[self.block_place[0], self.block_place[1] + self.indent + self.block_side_size],
                              self.block_size])
    ...
    def three_deck_ship(self, y):
        ...
        if y <= 7:
            pygame.draw.rect(display.screen, self.hologram_color,
                             [[self.block_place[0] + self.indent * 2 + self.block_side_size * 2, self.block_place[1]],
                              self.block_size])
    ...
    def inv_three_deck_ship(self, x):
        ...
        if x <= 7:
            pygame.draw.rect(display.screen, self.hologram_color,
                             [[self.block_place[0], self.block_place[1] + self.indent * 2 + self.block_side_size * 2],
                              self.block_size])
    ...
    def four_deck_ship(self, y):
        ...
        if y <= 6:
            pygame.draw.rect(display.screen, self.hologram_color,
                             [[self.block_place[0] + self.indent * 3 + self.block_side_size * 3, self.block_place[1]],
                              self.block_size])
    ...
    def inv_four_deck_ship(self, x):
        ...
        if x <= 6:
            pygame.draw.rect(display.screen, self.hologram_color,
                             [[self.block_place[0], self.block_place[1] + self.indent * 3 + self.block_side_size * 3],
                              self.block_size])
    ...
    def draw_field(self):
        ...
        for x in range(10):
            for y in range(10):
                if self.block_place[0] <= mouse_pose[0] <= self.block_place[0] + self.block_size[0] and \
                        self.block_place[1] <= mouse_pose[1] <= self.block_place[1] + self.block_size[1]:
                    if selected_ships == 1:
                        self.one_deck_ship()
